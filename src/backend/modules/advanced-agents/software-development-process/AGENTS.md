...
- Path: `packages/apps/ai-agents/src/services/ai-agents/advanced/software-development-process`
...
- Functions (all):
  - `executeSoftwareDevelopmentProcess` (L30-L30, function)
- Exports:
  - `buildSoftwareDevelopmentProcess` (L6)
  - `buildSoftwareProcessMatrices` (L7)
  - `buildSoftwareAgentWorkGraph` (L8)
  - `roleExpectedOutput` (L8)
  - `softwareDevelopmentRoles` (L8)
  - `defaultValueScore` (L9)
  - `processScoreCaps` (L9)
  - `executeSoftwareDevelopmentProcess` (L30)
- Key snippets and use-case mapping:
  - `L30-L30`: Implements `executeSoftwareDevelopmentProcess` for this module use case.
