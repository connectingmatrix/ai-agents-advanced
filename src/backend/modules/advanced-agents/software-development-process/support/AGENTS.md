...
- Path: `packages/apps/ai-agents/src/services/ai-agents/advanced/software-development-process/runtime`
...
- Functions (all):
  - `routePath` (L8-L8, arrow)
  - `tableName` (L9-L9, arrow)
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L8-L8`: Implements `routePath` for this module use case.
  - `L9-L9`: Implements `tableName` for this module use case.
### `llm-extract.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `extractSoftwareRequirementsWithLlm` (L18-L18, function)
- Exports:
  - `extractSoftwareRequirementsWithLlm` (L18)
- Key snippets and use-case mapping:
  - `L18-L18`: Implements `extractSoftwareRequirementsWithLlm` for this module use case.
### `matrices.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
...
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L1-L170`: File-level constants/types behavior.
### `roles.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
...
- Exports:
  - None
- Key snippets and use-case mapping:
  - `L1-L53`: File-level constants/types behavior.
### `stories.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `buildUserStories` (L3-L3, function)
  - `buildAcceptanceCriteria` (L13-L13, function)
  - `buildImplementationTasks` (L27-L27, function)
- Exports:
  - `buildUserStories` (L3)
  - `buildAcceptanceCriteria` (L13)
  - `buildImplementationTasks` (L27)
- Key snippets and use-case mapping:
  - `L3-L3`: Implements `buildUserStories` for this module use case.
  - `L13-L13`: Implements `buildAcceptanceCriteria` for this module use case.
  - `L27-L27`: Implements `buildImplementationTasks` for this module use case.
### `value-score.ts`
- Purpose: Defines module behavior owned by this usage folder.
- Owning use cases: Runtime and application flows that import this file through package boundaries.
- Input shape: Typed arguments and imported contracts declared in this file signatures.
...
- Logic gates summary:
  ...
  - MCP or GraphQL proxy boundaries must avoid duplicated domain validation.
- Functions (all):
  - `buildUiResearchArtifact` (L5-L5, function)
  - `buildAgentWorkPackets` (L15-L15, function)
  - `buildResearchBrief` (L30-L30, function)
- Exports:
  - `buildUiResearchArtifact` (L5)
  - `buildAgentWorkPackets` (L15)
  - `buildResearchBrief` (L30)
- Key snippets and use-case mapping:
  - `L5-L5`: Implements `buildUiResearchArtifact` for this module use case.
  - `L15-L15`: Implements `buildAgentWorkPackets` for this module use case.
  - `L30-L30`: Implements `buildResearchBrief` for this module use case.
