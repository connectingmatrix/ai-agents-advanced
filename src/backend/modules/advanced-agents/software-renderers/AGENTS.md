...
- Path: `packages/apps/ai-agents/src/services/ai-agents/advanced/software-renderers`
- This directory owns the production code files in this folder.
...
- Keep MCP adapters GraphQL-driven where applicable; do not duplicate business validation in MCP handlers.
