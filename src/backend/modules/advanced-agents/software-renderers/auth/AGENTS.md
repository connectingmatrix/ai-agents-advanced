...
- Path: `packages/apps/ai-agents/src/services/ai-agents/advanced/software-renderers/auth`
...
- Functions (all):
  - `homeScreenHtml` (L3-L3, arrow)
  - `authScreensHtml` (L15-L15, arrow)
- Exports:
  - `homeScreenHtml` (L3)
  - `authScreensHtml` (L15)
- Key snippets and use-case mapping:
  - `L3-L3`: Implements `homeScreenHtml` for this module use case.
  - `L15-L15`: Implements `authScreensHtml` for this module use case.
