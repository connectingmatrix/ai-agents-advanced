...
## `process-monitoring-final/src/imports/process_monitor_root_normal_light_dark_final-1.html`
...
Use this artifact when the Software Builder needs the `process-monitoring` pattern represented by `process_monitor_root_normal_light_dark_final-1.html`. Preserve imports, component boundaries, state names, and styling conventions shown in the snippet unless the target app requires a typed adaptation.
