...
- Use Root, Sidebar, GlobalHeader, EnhancedDataTable, CreateModal, FormField, Toast, and EmptyState for application scaffolds.
- Use DataTable or EnhancedDataTable for records; do not generate ad-hoc table markup unless a static preview needs it.
- Use FormField and CreateModal for create/update flows.
- Use ActivityPanel, LogViewer, and LogViewerTable for operational surfaces.
- Keep props explicit in generated examples: title, description, columns, rows, status, actions, and filters.
