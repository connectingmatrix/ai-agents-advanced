...
- Use Panel, PanelHeader, MetricCard, LiveBadge, StatusDot, SparklineChart, Legend, and SearchInput for runtime screens.
- Monitoring panels should include freshness, severity, owner, and remediation fields when available.
- Log views should preserve timestamp order and expose filtering by level/status.
