...
- Use TableSelector and TableMultiSelector for flat entity relationships.
- Use TreeSelector, TreeMultiSelector, and TreeSelectField for channel/category/subject-style hierarchy.
- Selector examples must include selected values, search labels, and empty states.
- Do not bypass selector components with raw dropdowns for relational data.
