...
- Approved primitives include button, card, badge, input, textarea, select, tabs, dialog, sheet, table, progress, alert, and tooltip.
- Compose primitives through domain components instead of duplicating primitive styling everywhere.
- Keep interactive affordances keyboard reachable and labeled.
- Do not add external UI dependencies unless the software template already declares them.
