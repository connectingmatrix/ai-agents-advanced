...
- Generated apps should use the UI kit visual system: sidebar shell, panel cards, rounded controls, status chips, and dense data surfaces.
- Use neutral product naming and domain-specific labels; do not include user-facing Giga branding.
- Keep responsive behavior: cards wrap, tables scroll, and nav works on narrow screens.
