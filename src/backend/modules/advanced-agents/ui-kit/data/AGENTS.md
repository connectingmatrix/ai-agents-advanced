...
- Use page-content and mock-data style fixtures as examples for generated seed data.
- Generated data must be domain-specific and stored in a project seed file.
- Do not hardcode platform accounts, secrets, or real customer data.
