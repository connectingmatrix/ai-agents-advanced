...
export function createPackageStatusPanel(context: RequestContext = {}): PackageLauncherPanel {
  return {
    ...
    title: '@connectingmatrix/ai-agents-advanced package status',
    mode: 'connected',
    status: 'ready',
    checkedAt: nowIso(),
    ...
    graphqlNamespace: 'aiagentsadvanced',
    routes: [{ method: 'GET', path: '/ai-agents-advanced/health', description: 'Package health endpoint' }],
