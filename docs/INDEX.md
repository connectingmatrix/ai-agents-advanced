# @connectingmatrix/ai-agents-advanced package index

## Ownership

Advanced derived agents such as planner, researcher, software builder, deployment, data analyst, output designer.
...
{
  "dependencies": {
    "@connectingmatrix/ai-agents-advanced": "file:../packages/ai-agents-advanced"
  }
}
```
