...
export function createConnectingmatrixAiAgentsAdvancedStubLauncher(context = {}) {
    return {
        ...
        actions: [
            { name: 'plan', label: 'plan', method: 'LOCAL', description: 'Run plan demo action' },
            { name: 'executePlan', label: 'executePlan', method: 'LOCAL', description: 'Run executePlan demo action' },
            { name: 'designOutput', label: 'designOutput', method: 'LOCAL', description: 'Run designOutput demo action' }
        ],
...
export const Launcher = { open: createConnectingmatrixAiAgentsAdvancedStubLauncher, mode: 'stub' };
